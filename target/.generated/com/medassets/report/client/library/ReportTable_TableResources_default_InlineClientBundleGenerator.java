...
public class ReportTable_TableResources_default_InlineClientBundleGenerator implements com.medassets.report.client.library.ReportTable.TableResources {
  private static ReportTable_TableResources_default_InlineClientBundleGenerator _instance0 = new ReportTable_TableResources_default_InlineClientBundleGenerator();
  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.medassets.report.client.library.ReportTable.TableStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GOJU5EJBGS{background-color:" + ("#f1f1f1")  + ";color:" + ("black")  + ";}.GOJU5EJBOR{padding-top:" + ("3px")  + ";padding-right:" + ("10px")  + ";padding-bottom:" + ("3px")  + ";border-bottom:" + ("1px")  + ";border-bottom-style:" + ("solid")  + ";border-bottom-color:" + ("#f0f0f0")  + ";border-top:" + ("1px")  + ";border-top-color:" + ("red")  + ";overflow:") + (("hidden")  + ";white-space:" + ("nowrap")  + ";}.GOJU5EJBBT{background:" + ("#e3eefb")  + ";color:" + ("black")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GOJU5EJBDT{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GOJU5EJBFS{background-color:" + ("#e2e2e2")  + ";background-image:" + ("url(table_background.png)")  + ";background-repeat:" + ("repeat-x") ) + (";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#000")  + ";padding:" + ("2px"+ " " +"10px"+ " " +"2px"+ " " +"10px")  + ";text-align:" + ("right")  + ";color:" + ("#fff")  + ";overflow:" + ("hidden")  + ";white-space:" + ("nowrap")  + ";font-weight:" + ("normal")  + ";font-family:" + ("\"Arial Unicode MS\""+ ","+ " " +"Arial"+ ","+ " " +"sans-serif")  + ";font-size:" + ("9pt")  + ";}.GOJU5EJBGT{white-space:" + ("nowrap")  + ";}")) : ((".GOJU5EJBGS{background-color:" + ("#f1f1f1")  + ";color:" + ("black")  + ";}.GOJU5EJBOR{padding-top:" + ("3px")  + ";padding-left:" + ("10px")  + ";padding-bottom:" + ("3px")  + ";border-bottom:" + ("1px")  + ";border-bottom-style:" + ("solid")  + ";border-bottom-color:" + ("#f0f0f0")  + ";border-top:" + ("1px")  + ";border-top-color:" + ("red")  + ";overflow:") + (("hidden")  + ";white-space:" + ("nowrap")  + ";}.GOJU5EJBBT{background:" + ("#e3eefb")  + ";color:" + ("black")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GOJU5EJBDT{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GOJU5EJBFS{background-color:" + ("#e2e2e2")  + ";background-image:" + ("url(table_background.png)")  + ";background-repeat:" + ("repeat-x") ) + (";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#000")  + ";padding:" + ("2px"+ " " +"10px"+ " " +"2px"+ " " +"10px")  + ";text-align:" + ("left")  + ";color:" + ("#fff")  + ";overflow:" + ("hidden")  + ";white-space:" + ("nowrap")  + ";font-weight:" + ("normal")  + ";font-family:" + ("\"Arial Unicode MS\""+ ","+ " " +"Arial"+ ","+ " " +"sans-serif")  + ";font-size:" + ("9pt")  + ";}.GOJU5EJBGT{white-space:" + ("nowrap")  + ";}"));
      }
